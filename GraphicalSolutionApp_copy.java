 ...
 */
public class GraphicalSolutionApp_copy extends AbstractSimulation {
  PlotFrame plotFrame = new PlotFrame("f(x)", "n", "graphical solution");
  ...
  public GraphicalSolutionApp_copy() {
  ...
  void drawFunction() {
    ...
    for(int i = 0;i<=nplot;i++) {
      y = f(x, r, iterate);
      plotFrame.append(0, y, i);
      // x += delta; taking this out for problem 1c
    }
  }
